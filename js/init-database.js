...
const initialCharacters = {
    ...
    maria: {
        ...
        image: 'https://cdn.pixabay.com/photo/2017/01/31/21/23/avatar-2027366_960_720.png'
    },
    chico: {
        name: 'Chico Mendes',
    ...
    dandara: {
        ...
        image: 'https://cdn.pixabay.com/photo/2017/01/31/21/23/avatar-2027365_960_720.png'
    },
    santos: {
        name: 'Santos Dumont',
        ...
        image: 'https://cdn.pixabay.com/photo/2016/03/31/19/57/avatar-1295406_960_720.png'
    },
    machado: {
...
// Dados iniciais das missões
const initialMissions = {
    carnaval: {
        name: 'As Origens do Carnaval',
        description: 'Explore as raízes culturais do Carnaval brasileiro, descobrindo as influências portuguesas, africanas e indígenas que moldaram esta festa única.',
        difficulty: 'iniciante',
        duration: '2-3 horas',
        story: 'Você se encontra no Rio de Janeiro do século XVIII. As ruas fervilham com preparativos para uma grande celebração. Diferentes culturas se misturam: portugueses com suas tradições europeias, africanos escravizados trazendo seus ritmos e danças, e indígenas com seus rituais ancestrais. Como seu personagem irá navegar por essa rica mistura cultural?',
        objectives: [
            'Descobrir as origens das tradições carnavalescas',
            'Mediar conflitos entre diferentes grupos culturais',
            'Preservar tradições autênticas de cada cultura',
            'Criar uma celebração verdadeiramente inclusiva'
        ],
        characters: ['Todos os personagens', 'Foco em diplomacia e cultura']
    },
    quilombo: {
        name: 'A Resistência de Palmares',
        description: 'Viva a épica resistência do Quilombo dos Palmares, enfrentando desafios de sobrevivência, organização social e defesa da liberdade.',
        difficulty: 'intermediario',
        duration: '3-4 horas',
        story: 'O ano é 1694. O Quilombo dos Palmares, maior símbolo de resistência negra no Brasil colonial, enfrenta seus momentos mais desafiadores. Expedições militares se aproximam, mas a comunidade permanece unida. Você deve ajudar a organizar a defesa, manter a moral alta e preservar a liberdade conquistada a tanto custo.',
        objectives: [
            'Organizar a defesa do quilombo contra invasores',
            'Manter a unidade e moral da comunidade',
            'Estabelecer rotas de fuga seguras',
            'Preservar a cultura e tradições quilombolas'
        ],
        characters: ['Zumbi dos Palmares', 'Dandara', 'Foco em liderança e combate']
    },
    amazonia: {
        name: 'Guardiões da Floresta',
        description: 'Proteja a Amazônia ao lado de Chico Mendes, enfrentando desafios ambientais e sociais na luta pela preservação.',
        difficulty: 'avancado',
        duration: '4-5 horas',
        story: 'Acre, década de 1980. A floresta amazônica enfrenta uma pressão sem precedentes. Fazendeiros, madeireiros e especuladores avançam sobre terras tradicionalmente ocupadas por seringueiros e povos indígenas. Você deve unir comunidades, sensibilizar autoridades e encontrar formas sustentáveis de desenvolvimento que preservem a maior floresta tropical do mundo.',
        objectives: [
            'Mobilizar comunidades locais para a preservação',
            'Negociar com autoridades e empresários',
            'Documentar crimes ambientais',
            'Desenvolver alternativas sustentáveis de renda'
        ],
        characters: ['Chico Mendes', 'Foco em diplomacia e ecologia']
    }
};
...
export async function initializeDatabase() {
    try {
        ...
        // Salvar personagens
        for (const [key, character] of Object.entries(initialCharacters)) {
            await setDoc(doc(db, 'personagens', key), character);
        }
        console.log('Personagens salvos no Firestore');
        
        // Salvar missões
        for (const [key, mission] of Object.entries(initialMissions)) {
            await setDoc(doc(db, 'missoes', key), mission);
        }
        console.log('Missões salvas no Firestore');
